...
This repository contains the base project part of our on-site GitHub Verified Partner workshop program. It is meant to be used for in-classroo/adsfasdfm training under the supervision of GitHub coaches.
